...
const packages = [
    {
        ...
        name: "King Amor",
        price: "70,000 ETB",
        description: "The crown jewel of AMOR. An unmatched, once-in-a-lifetime royal experience.",
        features: [
            "Exclusive Royal Penthouse Suite Access",
            "Private 12-Course Imperial Degustation",
            "Personal Butler & Concierge Service",
            "Live Solo Violinist performance at table",
            "Rolls Royce Chauffeur (Door-to-Door)",
            "Bespoke Diamond Jewelry Gift",
            "Vintage 1996 Champagne Collection",
            "Private Garden Lounge Access"
        ],
        icon: Crown,
        isKing: true,
    ...
    },
    {
        ...
        price: "35,000 ETB",
        description: "A refined evening of connection and charm.",
        features: [
            "Welcome Champagne Toast",
            "4-Course Premium Dinner",
            "Live String Quartette",
            "Selection of Premium Wines",
            "Reserved Elegant Seating"
        ],
        icon: Heart,
    },
    {
        ...
        name: "Premium Luxury",
        price: "45,000 ETB",
        description: "Maximum elegance for a night to remember.",
        features: [
            ...
            "Luxury Gift Bag",
            "Preferred Center-Stage Seating"
        ],
        icon: Star,
        popular: true
    },
    {
        ...
        name: "Diamond Elite",
        price: "60,000 ETB",
        description: "The ultimate expression of luxury and love.",
        features: [
            "Personal Butler Service",
            "Private Balcony Table",
            "Vintage Champagne Bottle",
            "Luxury Car Pick-up & Drop-off",
            "Custom Flower Arrangement",
            "Exclusive After-Party Access"
        ],
        icon: Diamond,
        limited: "Only 7 Tickets Available"
    }
];
                        ...
                        >
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-12 relative z-10">
                                <div className="max-w-xl">
                                    ...
                                    <ul className="hidden md:grid md:grid-cols-2 gap-x-12 gap-y-4">
                                ...
                                <div className="text-left md:text-right shrink-0">
                                    <div className="mb-8">
                                        ...
                                        <span className="text-champagne/30 text-[10px] block lg:inline lg:ml-2 uppercase tracking-[0.3em] font-bold">/ Sovereign</span>
                                    </div>
                                    <button
